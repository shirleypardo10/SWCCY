...
export const ROUTES_META: AppRouteMeta[] = [
  {
    ...
    label: "Inicio",
    isPublic: true,
    allowedRoles: ["ADMIN", "GERENTE", "VENDEDOR", "PRODUCTOR", "ALMACENERO"],
  ...
  },
  {
    ...
    isPublic: false,
    allowedRoles: ["ADMIN", "GERENTE", "VENDEDOR", "PRODUCTOR"],
    moduleKey: "pedidos",
  ...
  },
  {
    ...
    label: "Producción",
    isPublic: false,
    allowedRoles: ["ADMIN", "GERENTE", "PRODUCTOR"],
  ...
  },
  {
    ...
    label: "Inventario",
    isPublic: false,
    allowedRoles: ["ADMIN", "GERENTE", "ALMACENERO"],
